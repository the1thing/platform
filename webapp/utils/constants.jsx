...
export const Constants = {
    ...
    ATTACHMENT_ICON_SVG: "<img src='https://s3.ap-south-1.amazonaws.com/1thing-logos/upload_icon.svg' alt=''>",
    MATTERMOST_ICON_SVG: "<img src='https://s3.ap-south-1.amazonaws.com/1thing-logos/logo.png' alt='logo'>",
    ONLINE_AVATAR_SVG: "<img src='https://s3.ap-south-1.amazonaws.com/1thing-logos/online_avatar.svg' alt=''>",
    AWAY_AVATAR_SVG: "<img src='https://s3.ap-south-1.amazonaws.com/1thing-logos/away_avatar.svg' alt=''>",
    OFFLINE_AVATAR_SVG: "<img src='https://s3.ap-south-1.amazonaws.com/1thing-logos/offline_avatar.svg' alt=''>",

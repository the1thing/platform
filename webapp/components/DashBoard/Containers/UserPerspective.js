...
import {
  setPerspectiveAddUpdate,
  getAboutPerspectiveData
...
let TextInput = props => {
  return (
    <Row style={{ marginBottom: "24px" }} id={props.id}>
      <Col md={1} style={{ fontSize: "24px" }} className="about-link-textares">
        {props.no}.
      </Col>
      <Col md={11}>
        <div>
        ...
        <div>
          <div style={{ display: "flex" }}>
            <input
              ...
              style={{ color: props.color, width: "70%" }}
              onChange={props.onChangeTitile}
              className={props.linkClass ? "Error-link-input" : "link-input"}
              placeholder="http://product.com"
            />
            <div
              style={{ display: props.visibility, lineHeight: "35px" }}
          ...
          <textarea
            ...
            className={
              props.linkClass ? "Error-link-textares" : "about-link-textares"
            }
            rows={4}
            style={{ width: "100%" }}
...
class UserPerspective extends Component {
  ...
  componentWillMount = () => {
    let userId=this.props.perspectiveState.allProjectWorkspace._id;
    if(userId !== '' && userId !== 'undefined' && userId !== undefined){
    let url =
      basepath +
      "designer/getDesignerDetailsByStage/" +
      this.props.perspectiveState.allProjectWorkspace._id +
      "?stage=3";
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (temp.work !== "undefined" && temp.work !== undefined) {
  ...
  renderClass = () => {
    if (
      this.state.productTitle1 &&
      this.state.productContent1 &&
      this.state.productTitle2 &&
      this.state.productContent2 &&
      this.state.productTitle3 &&
      this.state.productContent3 &&
      this.state.workSpace &&
      this.state.necessaryThings1 &&
      this.state.necessaryThings2 &&
      this.state.necessaryThings3 &&
      this.state.userPersonality
    ) {
      return "Rectangle-4";
    } else {
  ...
  setUserPerpectiveData = () => {
    ...
    let _apigeturl =
      ...
      this.props.perspectiveState.allProjectWorkspace._id +
      "?stage=3";
    this.props.perspectiveAddUpdate(method, url, data, _apigeturl,getDesignerUrl);
    }
  };
  render() {
      ...
      return (
        <div>
          <div className="input-spacing">
            <div className="form-label">Product(s) you admire the most</div>
            <div
          ...
          <div className="input-spacing-radio">
            <div className="form-label">Where do you work from?</div>
          ...
          <div className="input-spacing">
            ...
            >
              <TextInput
                ...
                onChange={e => {
                  this.setstateMethod("necessaryThings1", e.target.value);
                }}
              />
              <TextInput
                id="thing2"
                ...
                placeholder="Clarity"
                onChange={e => {
                  this.setstateMethod("necessaryThings2", e.target.value);
                }}
              />
              <TextInput
                id="thing3"
                ...
                onChange={e => {
                  this.setstateMethod("necessaryThings3", e.target.value);
                }}
              />
            </div>
          </div>

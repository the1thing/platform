...
export default class OnboardingTitles extends Component {
  ...
  render() {
    return (
      <div>
        <div
          className={this.props.active ? "Rectangle-3" : "unactive-title"}
          style={{
            backgroundImage: this.props.active ? this.props.color : "",
        ...
        >
          <div
            className={
              this.props.active ? "-About-yourself" : "-Your-expertise"
            }
          >
            {this.props.title}
          </div>
          ...
          >
            <div className="date-container">
              <div className="Done-Sep-29-740p">
                {" "}
                {typeof this.props.date == "undefined" || this.props.date == ""
                  ? ""
                  : "Done  , " + this.props.date}
              </div>
              <div style={{ marginLeft: "8px" }}>
                ...
                this.props.date == "" ? (
                  ...
                  <img src={require("../Images/done.svg")} />
                )}
              </div>
            </div>
            <div>
              <div
                style={{
                  display: this.state.plus_visiblity,
                  marginLeft: "103px"
                }}
              ...
              <div
                style={{
                  display: this.state.minus_visiblity,
                  marginLeft: "103px"
                }}

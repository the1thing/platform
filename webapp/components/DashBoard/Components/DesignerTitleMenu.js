  ...
  render() {
    return (
        <div>
            ...
            <li style={{borderTop:'1px solid #ffbc00',color:'#ffbc00',height:'5px',width:this.state.requirement_width}}><span className="menu-title" style={{visibility:this.state.menu_requirements_visiblity}}>ONBOARDING</span></li>
            <li style={{borderTop:'1px solid #118bf3',color:'#118bf3',height:'5px',width:this.state.design_width}}><span className="menu-title" style={{visibility:this.state.menu_design_visiblity}}>ASSIGNMENT</span></li>
            <li style={{borderTop:'1px solid #36cb3b',color:'#36cb3b',height:'5px',width:this.state.analysis_width}}><span className="menu-title" style={{visibility:this.state.menu_analysis_visiblity}}>PRICING & BANDWIDTH</span></li>
            <li style={{borderTop:'1px solid #7560fd',color:'#7560fd',height:'5px',width:this.state.feedback_width}}><span className="menu-title" style={{visibility:this.state.menu_feedback_visiblity}}>WELCOME ABOARD</span></li>
          </ul>

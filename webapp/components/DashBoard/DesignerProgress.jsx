...
class DesignerProgress extends Component {
  ...
  componentWillReceiveProps = nextProps => {
    ...
    if (
      nextProps.designerState.allProjectWorkspace.statusBar.aboutYourself
        .completed == false
    ) {
      ...
      this.state.onboarding.aboutYourself.completed =
        temp.aboutYourself.completed;
      this.state.onboarding.yourExpertise.completed = temp.expertise.completed;
      this.state.onboarding.yourPerspective.completed =
        temp.perspective.completed;
      this.state.onboarding.howYouThink.completed =
        temp.thinkAboutYourself.completed;
      this.state.onboarding.howYouThink.completedDate =
        temp.thinkAboutYourself.completedDate;
      this.state.onboarding.dateOfCompletion =
        temp.thinkAboutYourself.completedDate;
      ...
      <div>
        <Row className="margin_bu16">
          <Col md={1}>
            <div
              className={
                this.state.onboarding.completed.value
                  ? "check_Oval_md"
                  : "Oval_md"
              }
            />
          ...
          >
            {returnDate(this.state.onboarding.dateOfCompletion)}
          </Col>
        </Row>
        <Row className={this.state.margin_bu8_onboarding}>
            ...
            <Col md={1}>
              <div
                className={
                  this.state.onboarding.aboutYourself.completed
                    ? "check_Oval_sm"
                    : this.state.not_cross_aboutYourself
                      ? "Oval_sm"
                      : "dim_Oval_sm"
                }
              />
          ...
          <Row className="margin_bu8">
            <Col md={1}>
              <div
                className={
                  this.state.onboarding.yourExpertise.completed
                    ? "check_Oval_sm"
                    : this.state.not_cross_yourExpertise
                      ? "Oval_sm"
                      : "dim_Oval_sm"
                }
              />
            ...
            <Col md={1}>
              <div
                className={
                  this.state.onboarding.yourPerspective.completed
                    ? "check_Oval_sm"
                    : this.state.not_cross_yourPerspective
                      ? "Oval_sm"
                      : "dim_Oval_sm"
                }
              />
            ...
            <Col md={1}>
              <div
                className={
                  this.state.onboarding.howYouThink.completed
                    ? "check_Oval_sm"
                    : this.state.not_cross_howYouThink
                      ? "Oval_sm"
                      : "dim_Oval_sm"
                }
              />
      ...
      <div>
        <Row className="margin_bu16">
          <Col md={1}>
            <div
              className={
                this.state.assignment.completed.value
                  ? "check_Oval_md"
                  : this.state.check_assignment_nextpart
                    ? "Oval_md"
                    : "dim_Oval_md"
              }
            />
        ...
        <div className={this.state.margin_bu8_assignment}>
          <Row className="margin_bu8">
            <Col md={1}>
              <div
                className={
                  this.state.assignment.inProcess.completed
                    ? "check_Oval_sm"
          ...
          <Row className="margin_bu8">
            <Col md={1}>
              <div
                className={
                  this.state.assignment.received.completed
                    ? "check_Oval_sm"
          ...
          <Row className="margin_bu8">
            <Col md={1}>
              <div
                className={
                  this.state.assignment.approval.completed
                    ? "check_Oval_sm"
      ...
      return (
        <Grid style={{ width: "90%" }}>
          <Row className="margin_bu28">
            ...
            <Col md={8} className="progress_text_main">

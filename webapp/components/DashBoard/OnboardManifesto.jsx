...
export default class OnboardManifesto extends Component {
  ...
  render() {
    return (
      <div>
        <div>
          <div className="_heading">1THING believes in .. (The Manifesto)</div>
          <div className="bold_border">
            <div className="bold_border_content_top">
              Everyone and everything has a purpose.
              <div style={{ marginTop: "8px" }}>
                Did anybody ever consider the importance of one purposeful thing
                in our lives? We do a lot of things but do they all become the
                part of the story behind our life satisfaction?
              </div>
              We are a ‘community of purpose’; a group of people who believes in
              doing things in a purposeful and empathetic way. We believe things
              which are designed this way are always much more appealing to the
              soul and act as better absorbents to the mind. We admire the
              problem diggers, the change seekers, the discoverers and ones with
              a purpose of bringing life to their designs.
              <div style={{ marginTop: "8px" }}>
                We believe that purpose is everything that matters in this life.
              </div>
            </div>
            <div className="bold_border_content_bottom">
              1THING is everything that nurtures/cultivates escalates that
              purpose.
            </div>
          </div>
            ...
            <div className="quotes">
              ...
              <span>
                <img
                  ...
                  src={require("./Images/left-quote.svg")}
                />
                <img
                  className="img-circle"
              ...
              <span>
                <img
                  ...
                  onClick={() => {
                    ...
                    this.setState({
                      tweet_id: this.state.tweet_data[tweet_count]
                    });
                  }}
                  width="24px"
                  height="24px"
